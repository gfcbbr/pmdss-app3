export function ProductionDashboard() {
  return (
    <div style={{ padding: '32px' }}>
      <h1 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '24px' }}>Üretim Yöneticisi Paneli</h1>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
        {[
          { label: 'Aktif Makine', value: '24', color: '#22C55E' },
          { label: 'Bakımda', value: '3', color: '#F59E0B' },
          { label: 'Arızalı', value: '1', color: '#EF4444' },
        ].map(kpi => (
